The chapter below contains examples of mathematical expression appearing in engineering problem formulations. In general, these expressions can be sub-divided into the following categories:
\begin{enumerate}
